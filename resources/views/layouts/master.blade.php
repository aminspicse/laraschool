...
<link rel="stylesheet" href="{{url('public/template/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{url('public/template/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  <link rel="stylesheet" href="{{url('public/template/bower_components/jvectormap/jquery-jvectormap.css')}}">
  <!-- Date Picker -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('home')}}" class="logo">
      ...
      <span class="logo-lg"><b>Binary School </b>Ltd.</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ url('public/template/dist/img/user2-160x160.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('public/template/dist/img/user2-160x160.jpg')}}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{Auth::user()->user_name}} - Teacher
                  <small>{{Auth::user()->inst_name}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="{{url('/admin/edit')}}">Update Profile</a>
                  </div>
                  <div class="col-xs-4 text-center">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('/lib/subject/')}}"><i class="fa fa-circle-o"></i>Subject</a></li>
            <li><a href="{{url('/lib/class/')}}"><i class="fa fa-circle-o"></i>Class</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="container row" style="">
    ...
    @if(Session::has('create'))
      <h2 class="alert alert-success text-center">{{Session::get('create')}}</h2>
    @endif
    @if(Session::has('update'))
      <h2 class="alert alert-info text-center">{{Session::get('update')}}</h2>
    @endif
    @if(Session::has('inactive'))
      <h2 class="alert alert-danger text-center">{{Session::get('inactive')}}</h2>
    @endif
  </div>
  @if(Auth::user()->auth_code != '' && Auth::user()->auth_code != 'null' && Auth::user()->auth_code != 0)

    <!-- /. main content -->
    @yield('content')
  @else
    <div class="row container">
        <h1 class="text-danger">Authentication Required</h1>
        <h1 class="text-danger">Please Contact Our Help Line 01689-015612</h1>
    </div>
  @endif
  </div>
  <!-- /.content-wrapper -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="www.myspeec.com">Myspeec</a>.</strong> All rights
    reserved.
  </footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{url('public/template/bower_components/jquery-ui/jquery-ui.min.js')}}"></script>
...
<!-- Morris.js charts -->
<script src="{{url('public/template/bower_components/raphael/raphael.min.js')}}"></script>
<script src="{{url('public/template/bower_components/morris.js/morris.min.js')}}"></script>
<!-- Sparkline -->
<script src="{{url('public/template/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')}}"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="{{url('public/template/bower_components/jquery-knob/dist/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
